          ...
          <Box pt={5} pb={5} className={classes.box}>
            <Grid container spacing={5}>
              <Grid item xs={12} md={6} lg={6}>
                ...
                <Box pl={4}>
                  <Title
                    content="Nombre de personnes reçues en 2020"
                    color="black"
                    size="h6"
                  />
                </Box>
              ...
              <Grid item xs={12} md={6} lg={6}>
                ...
                <Box pl={4}>
                  <Title
                    content="Nombre de jours de location en 2020"
                    color="black"
                    size="h6"
                  />
                </Box>
              ...
              <Grid item xs={12} md={6} lg={6}>
                ...
                <Box pl={4}>
                  <Title
                    content="Nombre d'adhérents en 2020"
                    color="black"
                    size="h6"
                  />
                </Box>
