...
import {
  ...
  getAdherents,
  getCoordinateurs,
  filterAdherentsFromSelectedDepartments,
  getExpertises,
...
const Region = ({
  ...
  const adherentsFiltered = adherents.filter(
    (adh) => adh?.region_siege?.nom_region === region
  );
  const [adherentsToDisplay, setAdherentsToDisplay] = useState(
    adherents.filter((adh) => adh?.region_siege?.nom_region === region)
  );
  const [adherentsToDisplayExpertise, setAdherentsToDisplayExpertise] =
    useState(
      adherents.filter((adh) => adh?.region_siege?.nom_region === region)
    );
  // Get filtered Departments
  const regionDepartments = departments.filter(
    (dep) => dep?.region?.nom_region === region
  );

  // Get filtered coordinateur
  const uniqueCoordinateur = coordinateurs.find(
    (c) => c?.region?.nom_region === region
  );
  const getStyles = (departement, mainDepartementSelected) => {
    return {
      fontWeight:
        mainDepartementSelected.indexOf(departement) === -1 ? "normal" : "bold",
    };
  };
  ...
  useEffect(() => {
    const resultDeps = filterAdherentsFromSelectedDepartments(
      adherentsFiltered,
  ...
  useEffect(() => {
    const resultExp = filterAdherentsFromSelectedExpertises(
      adherentsFiltered,
  ...
  const regionAdherents = adherentsToDisplay.filter((element) =>
    adherentsToDisplayExpertise.includes(element)
  );
  ...
  const _handleClick = (site) => {
    ...
    if (
      url.substr(0, prefixHttp.length) !== prefixHttp &&
      url.substr(0, prefixHttps.length) !== prefixHttps
    ) {
      url = prefix + url;
    }
    if (isWindowContext) {
                  ...
                  <Grid item xs={12}>
                    <FormControl className={classes.formControl}>
                      ...
                      <Select
                        ...
                        // onChange={handleChangeDepartment}
                        onChange={(event) =>
                          setMainExpertiseSelected(event.target.value)
                        }
                        input={<Input />}
                        MenuProps={MenuProps}
                      >
                  ...
                  <Box key={index} mt={3}>
                    ...
                    <Grid container>
                      {regionAdherents
                        .filter(
                          (adh) =>
                            adh?.departement_siege?.nom_departement ===
                            dep.nom_departement
                        )
                        .map((d, i) => (
                            ...
                            <Grid item xs={6}>
                              ...
                              <Box mb={1}>
                                <Title
                                  ...
                                  bold
                                  content={
                                    uniqueCoordinateur.telephone_president || ""
                                  }
                                />
                              </Box>
                              <Box mb={1}>
                                <Title
                                  ...
                                  content={
                                    (
                                      ...
                                      >
                                        {uniqueCoordinateur.email_president}
                                      </a>
                                    ) || ""
                                  }
                                />
                            ...
                            <Grid item xs={6}>
                              ...
                              <Box mb={1}>
                                <Title
                                  ...
                                  bold
                                  content={
                                    uniqueCoordinateur.telephone_co_president ||
                                    ""
                                  }
                                />
                              </Box>
                                ...
                                <Title
                                  ...
                                  content={
                                    (
                                      ...
                                      >
                                        {uniqueCoordinateur.email_co_president}
                                      </a>
                                    ) || ""
                                  }
                                />
                              ...
                              <Grid item xs={6}>
                                ...
                                <Box mb={1}>
                                  <Title
                                    ...
                                    bold
                                    content={
                                      uniqueCoordinateur.telephone_charge_developpement ||
                                      ""
                                    }
                                  />
                                </Box>
                                  ...
                                  <Title
                                    ...
                                    content={
                                      (
                                        ...
                                        >
                                          {
                                            uniqueCoordinateur.email_charge_developpement
                                          }
                                        </a>
                                      ) || ""
                                    }
